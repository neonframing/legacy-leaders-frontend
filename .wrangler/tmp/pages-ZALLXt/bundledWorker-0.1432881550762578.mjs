...
var G = /* @__PURE__ */ __name((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "G");
var pe = /* @__PURE__ */ __name((e, t, r, s) => {
  if (t && typeof t == "object" || typeof t == "function") for (let a of ae(t)) !ce.call(e, a) && a !== r && z(e, a, { get: /* @__PURE__ */ __name(() => t[a], "get"), enumerable: !(s = ne(t, a)) || s.enumerable });
  return e;
}, "pe");
var B = /* @__PURE__ */ __name((e, t, r) => (r = e != null ? re(oe(e)) : {}, pe(t || !e || !e.__esModule ? z(r, "default", { value: e, enumerable: true }) : r, e)), "B");
var h;
var i = M(() => {
  h = { collectedLocales: [] };
});
...
async function P(e, { request: t, assetsFetcher: r, ctx: s }, { path: a, searchParams: o }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        n = w(await r.fetch(I(p, e.path ?? a))), e.headers && m(n.headers, e.headers);
        break;
      }
      case "static": {
        n = await r.fetch(I(p, a));
        break;
      }
      default:
...
async function $(e) {
  ...
  try {
    ...
    switch (e.method) {
      ...
      case "POST": {
        let o = globalThis[ye], n = /* @__PURE__ */ __name(async () => {
          let c = await e.json();
...
var k = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: a } } = t, o = a && this.cookies[a], n = H(o ?? ""), c = H(this.reqCtx.request.headers.get("accept-language") ?? ""), g = [...n, ...c].map((y) => s[y]).filter(Boolean)[0];
    if (g) {
...
function Me() {
  ...
  return new Proxy(globalThis, { get: /* @__PURE__ */ __name((t, r) => e.has(r) ? e.get(r) : Reflect.get(globalThis, r), "get"), set: /* @__PURE__ */ __name((t, r, s) => Ee.has(r) ? Reflect.set(globalThis, r, s) : (e.set(r, s), true), "set") });
}
__name(Me, "Me");
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.1432881550762578.mjs.map
