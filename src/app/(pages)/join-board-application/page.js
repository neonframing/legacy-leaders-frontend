...
const boardOptions = ["Young Professionals", "Advisory", "Fundraising"];

export default function JoinBoardApplicationPage() {
      ...
      <main className="pt-28 pb-16 lg:pt-40 lg:pb-24">
        <div className="mx-auto max-w-5xl px-6 lg:px-10">
          <div className="mb-10 border-l-4 border-[#D89B2B] bg-white p-6 sm:p-8">
            <p className="mb-3 text-sm font-bold uppercase tracking-[0.24em] text-[#D89B2B]">Board Application {currentYear}</p>
            <h1 className="text-3xl font-black uppercase tracking-tight text-[#344059] sm:text-4xl">Join a Board Application</h1>
            <p className="mt-6 text-sm leading-relaxed text-gray-600 sm:text-base">
              Thank you for your interest in serving with Legacy Leaders. Please complete this form in one sitting. Fields marked
          ...
          <form className="space-y-10" action="#" method="post" encType="multipart/form-data">
            ...
            <section className="bg-white p-6 sm:p-8 border border-[#344059]/10">
              <h2 className="text-sm font-bold uppercase tracking-[0.24em] text-[#D89B2B]">Board Interest</h2>

              <div className="mt-6">
                <p className="mb-3 text-sm font-bold uppercase tracking-widest text-[#344059]">What board are you interested in joining? *</p>
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
                  {boardOptions.map((option) => (
                    <label key={option} className="flex items-center gap-3 text-sm text-gray-700">
                      <input type="radio" name="boardInterest" value={option} className="h-4 w-4 accent-[#D89B2B]" required />
                      {option}
                    </label>
                  ))}
                </div>
              ...
              <div className="mt-6">
                <label className="mb-2 block text-sm font-bold uppercase tracking-widest text-[#344059]" htmlFor="boardWhyAndSkills">
                  Why do you want to join this board and what skills can you offer? *
                </label>
                <textarea
                  id="boardWhyAndSkills"
                  name="boardWhyAndSkills"
                  rows={5}
                  required
